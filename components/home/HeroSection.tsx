    ...
    <section className="relative min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-hidden">
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          >
            const skills = ["React", "Typescript", "Html", "Css", "Scss", "C#", "Docker", "AWS", "Nestjs",
              "Javascript", "Git", "Graphql", "Figma", "Nextjs", "TailwindCss", "Linux"
            ];
          </motion.div>
          <motion.div 
      ...
      <div className="relative z-10 container mx-auto px-6 py-20">
        <div className="text-center mb-8">
          ...
          >
            <span className="text-blue-400 text-sm font-medium">👨‍💻 Crafting Digital Solutions</span>
          </motion.div>
          ...
          >
            <h1 className="text-6xl md:text-8xl font-bold text-white mb-6">
              ...
              <span className="block text-blue-400 font-light text-2xl md:text-3xl mb-2">Peter Dinis</span>
              Full Stack
          ...
          >
            Transforming ideas into powerful digital solutions through clean code and innovative design.
          ...
          >
            {["React", "Typescript", "Html", "Css", "Scss", "C#", "Docker", "AWS", "Nestjs", "Javascript", "Git", "Graphql", "Figma", "Nextjs", "TailwindCss", "Linux"].map((tech, index) => (
              <motion.span 
                key={index} 
        ...
        >
          ...
          >
            <div className="text-2xl font-bold text-green-400 font-mono">50+</div>
      ...
      >
        ...
        <p className="text-white/50 text-xs mt-2 text-center font-mono">scroll()</p>
      </motion.div>
    </section>
  );
};
